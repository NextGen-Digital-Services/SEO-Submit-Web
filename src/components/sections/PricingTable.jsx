...
const PricingTable = () => {
  return (
    <section id="pricing" className="pricing-section section-padding relative overflow-hidden">
      {/* Decorative Glow */}
      <div className="glow-blur pricing-glow" style={{ bottom: '10%', right: '10%', width: '400px', height: '400px', backgroundColor: 'var(--primary-glow)' }}></div>
        ...
        <div className="grid-4 pricing-grid">
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              {/* Action button */}
              <Link to="/contact" className={`btn btn-block mb-4 ${plan.popular ? 'btn-orange' : 'btn-secondary'}`}>
                {plan.cta}
              </Link>
                ...
                <ul className="plan-features-list">
                  {plan.features.map((feature, idx) => (
                    <li key={idx} className="feature-item">
                      <svg className="feature-check" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
