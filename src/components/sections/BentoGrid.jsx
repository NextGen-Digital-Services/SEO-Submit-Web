...
const BentoGrid = () => {
  ...
  return (
    <section id="services" className="feature-section section-padding relative" aria-label="Lead Optimization Features">
      <div className="container">
        <div className="section-title-wrapper animate-slide-up" style={{ textAlign: 'center', marginBottom: '40px' }}>
        ...
        <div className="feature-cards-grid">
          {features.map((feature, index) => (
            <article className="glass-card feature-card animate-slide-up" key={index} style={{ animationDelay: `${0.1 * index}s`, borderTop: `4px solid ${feature.accentColor}` }}>
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .feature-card {
            padding: 24px; /* Slightly tighter on mobile view padding */
          }
