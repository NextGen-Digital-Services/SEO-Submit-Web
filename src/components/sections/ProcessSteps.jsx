...
const ProcessSteps = () => {
  ...
  return (
    <section id="process" className="process-section section-padding relative overflow-hidden" aria-label="Lead Qualification Sourcing Process Flow">
      {/* Decorative Glow */}
      <div className="glow-blur process-glow" style={{ top: '20%', right: '5%', width: '300px', height: '300px', backgroundColor: 'var(--primary-glow)', pointerEvents: 'none' }}></div>
      ...
      <div className="container">
        ...
        <div className="process-flow relative">
          ...
          <ol className="process-grid" style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            {steps.map((step, idx) => (
              <li 
                className="glass-card process-step-card relative animate-slide-up"
                key={idx}
      ...
      <style>{`
        ...
        .desktop-connector-line {
          position: absolute;
          top: 52px; /* Balanced center vertical height alignment for 44px numbers */
          left: 12%;
          right: 12%;
          height: 2px;
